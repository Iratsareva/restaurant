...
- **[Быстрая проверка](БЫСТРАЯ_ПРОВЕРКА.md)** - основные команды для тестирования
- **[Полный гайд тестирования](ПОЛНЫЙ_ГАЙД_ТЕСТИРОВАНИЯ.md)** - подробная инструкция по проверке всех компонентов
- **[Настройка зависимостей](DEPENDENCIES_SETUP.md)** - установка зависимостей на новом устройстве
- **[Jenkins + Docker](ПОЛНАЯ_ИНСТРУКЦИЯ_ВЫПОЛНЕНИЯ_ЗАДАНИЯ.md)** - полная инструкция выполнения задания
